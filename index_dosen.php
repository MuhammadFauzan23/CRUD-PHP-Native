...
<body>
  ...
  <div class="row no-gutters mt-5">
    ...
    <div class="col-md-10 p-5 pt-2">
      ...
      <hr>
      <a href="#" class="btn btn-primary mb-2" data-toggle="modal" data-target="#tambah_dsn">
        <i class="fas fa-plus-circle mr-2"></i>TAMBAH DATA DOSEN</a>
      <a href="laporan_dosen.php" class="btn btn-success mb-2"><i class="fas fa-reply mr-2"></i>Cetak</a>
      ...
      <table class="table table-striped table-bordered">
        ...
        $query = mysqli_query($koneksi_dosen, "SELECT * FROM dosen");
        $no = 1;
        ...
        ?>
          <tr>
            ...
            <td>
              ...
              <a href="#" data-toggle="modal" data-target="#editdsn<?php echo $data['nidn']; ?>">Edit</a>
              <i class="fas fa-trash-alt bg-danger p-2 text-white rounded"></i>
              <a href="#" data-toggle="modal" data-target="#deletedsn<?php echo $data['nidn']; ?>">Delete</a>
            </td>
          </tr>
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form action="update_dosen.php" method="post" role="form">
                      <?php
                      $nidn = $data['nidn'];
                      $query1 = mysqli_query($koneksi_dosen, "SELECT * FROM dosen WHERE nidn='$nidn'");
                      ...
                      ?>
                        ...
                        <div class="form-group">
                          <div class="row">
                            ...
                            <div class="col-sm-8"><input type="text" name="jabatan" class="form-control" value="<?php echo $data1['jabatan']; ?>">
                              </input>
                            </div>
                          </div>
                        </div>
            ...
            <div id="deletedsn<?php echo $data['nidn']; ?>" class="modal fade" role="dialog" style="display:none;">
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <h5 align="center">Apakah anda yakin ingin menghapus NIDN <?php echo $data['nidn']; ?><strong><span class="grt"></span></strong> ?</h5>
                  </div>
                  <div class="modal-footer">
                    <button id="nodelete" type="button" class="btn btn-danger pull-left" datadismiss="modal">Cancle</button>
                    <a href="hapus_dosen.php?nidn=<?php echo $data['nidn']; ?>" class="btn btn-primary">Delete</a>
                  </div>
  ...
  <!-- Simpan Modal  -->
  <div class="example-modal">
    <div id="tambah_dsn" class="modal fade" role="dialog" style="display:none;">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="simpan_dosen.php" method="post" role="form">
              <div class="form-group">
                <div class="row">
                  <label class="col-sm-3 control-label text-right">NIDN</label>
                  <div class="col-sm-8"><input type="text" class="form-control" name="nidn" placeholder="Masukkan Nidn" value=""></div>
                </div>
              </div>
              <div class="form-group">
                <div class="row">
              ...
              <div class="form-group">
                <div class="row">
                  <label class="col-sm-3 control-label text-right">Alamat</label>
                  <div class="col-sm-8"><input type="text" class="form-control" name="alamat" placeholder="Masukkan Alamat" id="alamat" value="">
              ...
              <div class="form-group">
                <div class="row">
                  <label class="col-sm-3 control-label text-right">Jabatan </label>
                  <div class="col-sm-8"><input type="text" name="jabatan" class="form-control" placeholder="Masukkan Jabatan">
                    </input>
                  </div>
                </div>
              </div>
