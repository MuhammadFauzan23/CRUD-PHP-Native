...
<body>
  ...
  <div class="row no-gutters mt-5">
    ...
    <div class="col-md-10 p-5 pt-2">
      ...
      <a href="laporan_mahs.php" class="btn btn-success mb-2"><i class="fas fa-reply mr-2"></i>Cetak</a>
          ...
          <div class="modal-body">
            <form action="simpan_mhs.php" method="post" role="form">
              <div class="form-group">
                <div class="row">
                  <label class="col-sm-3 control-label text-right">NIM</label>
                  <div class="col-sm-8"><input type="text" class="form-control" name="nim" placeholder="Masukkan NIM" value=""></div>
                </div>
              </div>
              <div class="form-group">
                <div class="row">
              ...
              <div class="form-group">
                <div class="row">
                  <label class="col-sm-3 control-label text-right">Jurusan </label>
                  <div class="col-sm-8"><input type="text" name="jurusan" class="form-control" placeholder="Masukkan Jurusan">
                    </input>
                  </div>
                </div>
              </div>
