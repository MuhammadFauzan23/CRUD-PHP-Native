<?php 
include 'koneksi_dosen.php'; $nidn = $_GET['nidn']; 
$result = mysqli_query($koneksi_dosen, "SELECT * FROM dosen WHERE nidn='$nidn'"); while($user_data = mysqli_fetch_array($result)) 
{ 
    $nama = $user_data['nama']; 
...
target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" arialabel="Toggle navigation"> 
 ...
 <div class="form-row"> 
  ...
  <div class="form-row"> 
     <div class="form-group col-md-6">       <label >JABATAN</label> 
